export type TileType = 'go' | 'property' | 'railroad' | 'utility' | 'tax' | 'chance' | 'community_chest' | 'jail' | 'go_to_jail' | 'free_parking';
...
export type Tile = GoTile | JailTile | GoToJailTile | FreeParkingTile | TaxTile | ChanceTile | CommunityChestTile | PropertyTile | RailroadTile | UtilityTile;
...
export type CardType = 'collect_from_bank' | 'pay_to_jackpot' | 'move_to' | 'move_back' | 'go_to_jail' | 'collect_from_players' | 'repair_costs' | 'move_to_nearest_railroad';
...
export type TurnPhase = 'waiting_for_roll' | 'rolling' | 'moving' | 'tile_action' | 'buy_or_auction' | 'auction_in_progress' | 'build_option' | 'jail_decision' | 'bankrupt_resolution' | 'end_turn';
